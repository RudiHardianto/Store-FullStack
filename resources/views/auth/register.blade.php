        ...
        <div class="col-lg-4">
          ...
          <form action="" class="mt-3">
            ...
            <div class="form-group">
              ...
              <input type="text" name="full-name" id="full-name" class="form-control is-valid" v-model="name"
                autofocus />
            </div>
            <!-- Email -->
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="store_open" id="openStoreFalse"
                  v-model="store_open" :value="false" />
            ...
            <!-- Nama Toko -->
            <div class="form-group" v-if="store_open">
...
<script src="https://www.unpkg.com/vue-toasted"></script>
<script>
  Vue.use(Toasted);
