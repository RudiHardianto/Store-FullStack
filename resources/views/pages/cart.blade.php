          ...
          <table class="table table-borderless table-cart">
            ...
            <tbody>
              <tr>
                ...
                <td style="width: 35%">
                  <div class="product-title">$29,222</div>
              ...
              <tr>
                ...
                <td style="width: 35%">
                  ...
                  <div class="product-subtitle">by Nike</div>
                </td>
                <td style="width: 35%">
                  <div class="product-title">$80,223</div>
                  <div class="product-subtitle">USD</div>
                </td>
                <td style="width: 20%">
                  <a href="#" class="btn btn-remove-cart">Remove</a>
              ...
              <tr>
                ...
                <td style="width: 35%">
                  ...
                  <div class="product-subtitle">by Starbuck</div>
                </td>
                <td style="width: 35%">
                  <div class="product-title">$13,328</div>
                  <div class="product-subtitle">USD</div>
                </td>
                <td style="width: 20%">
                  <a href="#" class="btn btn-remove-cart">Remove</a>
